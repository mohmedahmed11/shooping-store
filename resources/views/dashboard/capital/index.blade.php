...
<div class="card">
    <div class="card-header">
        <h4 class="card-title">الدفعيات</h4>
    </div>
                        ...
                        <tr role="row" class="odd">
                            ...
                            <td>
                                @if (auth()->user()->hasPermission('users_delete'))
                                    <a href="{{ route('capital.delete', $expens->id) }}" id="delete" class="btn btn-outline-danger"><i class="fa fa-trash"></i>حذف</a>
                                @else
...
<div class="card-header">
        ...
        <h4 class="text-uppercase">اضافة دفعيات </h4>
